                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-blog">
                            <div class="blog-image">
                                <a href="single-blog.html"><img src="assets/images/blog/blog-small/blog-1.jpg" alt=""></a>
                            </div>
                            <div class="blog-content">
                                <h2><a href="single-blog.html">Bouygues UK slumps to £78m loss for 2016</a></h2>
                                <ul class="meta">
                                    <li><i class="fa fa-clock-o"></i>10 October 2018</li>
                                    <li><i class="fa fa-folder-open"></i><a href="#">News</a></li>
                                </ul>
                                <p>The UK arm of French contractor Bouygues saw its turnover increase but pre-tax losses
                                    slumped to £78m …</p>
                                <a class="read-more-btn" href="single-blog.html">Read more <i
